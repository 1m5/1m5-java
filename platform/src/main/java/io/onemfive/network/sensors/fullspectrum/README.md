# Full Radio Spectrum access
Slated for 1M5 0.8.6

## Introduction
The full spectrum radio component uses the full radio electromagnetic spectrum to aid in censorship resistant communications.
