package io.onemfive.network.peers.db.derby;
...
public class DerbyPeerDB implements PeerDB {

    private static final Logger LOG = Logger.getLogger(DerbyPeerDB.class.getName());
