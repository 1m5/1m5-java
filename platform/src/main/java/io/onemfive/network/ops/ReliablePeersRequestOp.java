...
public class ReliablePeersRequestOp extends NetworkOpBase {

    private static final Logger LOG = Logger.getLogger(ReliablePeersRequestOp.class.getName());

    public ReliablePeersRequestOp(SensorManager sensorManager) {
        super(sensorManager);
    }
