...
/**
 * Stores keys using them to send and receive {@link io.onemfive.monetary.btc.Satoshi}
 * encapsulated in a {@link io.onemfive.monetary.btc.blockchain.Transaction}.
 *
 */
public class Wallet {
