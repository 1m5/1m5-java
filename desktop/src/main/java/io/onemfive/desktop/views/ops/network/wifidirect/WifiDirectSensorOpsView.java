...
public class WifiDirectSensorOpsView extends ActivatableView implements SensorStatusListener, TopicListener {
    ...
    protected void initialize() {
        ...
        wifidirectFriendlynameTextField = addCompactTopLabelTextField(pane, ++gridRow, Res.get("ops.network.wifidirect.friendlyNameLabel"), wifidirectFriendlyName, Layout.FIRST_ROW_DISTANCE).second;
    ...
    public void modelUpdated(String name, Object object) {
        if(object instanceof NetworkPeer) {
            ...
            wifidirectFriendlyName = peer.getDid().getUsername();
            wifidirectAddress = peer.getDid().getPublicKey().getAddress();
