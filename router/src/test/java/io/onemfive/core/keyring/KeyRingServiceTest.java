 ...
 *
 * TODO: Ignored as these tests are outdated
 * @author objectorange
 */
@Ignore
public class KeyRingServiceTest {
    ...
    public void symmetricCryption() {
        ...
        try {
            ...
            if(er.statusCode != ServiceMessage.NO_ERROR) System.out.println("Encryption Error Code: "+er.statusCode);
            ...
            if(dr.statusCode != ServiceMessage.NO_ERROR) System.out.println("Decryption Error Code: "+dr.statusCode);
            assert dr.statusCode == ServiceMessage.NO_ERROR;
    ...
    public void asymmetricCryptionOfPassphrase() {
        ...
        ee.setRoute(ee.getDynamicRoutingSlip().nextRoute());
        service.handleDocument(ee);
        assert er.statusCode == Request.NO_ERROR;
        ...
        de.setRoute(de.getDynamicRoutingSlip().nextRoute());
        service.handleDocument(de);
        assert dr.statusCode == Request.NO_ERROR;
